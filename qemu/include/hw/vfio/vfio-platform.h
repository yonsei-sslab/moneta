...
#define PLATFORM_MALI(obj) \
     OBJECT_CHECK(VFIOPlatformDevice, obj, TYPE_PLATFORM_MALI)
...
extern const VMStateDescription vmstate_platform_device;

#define VMSTATE_PLATFORMBUS_DEVICE(_field, _state) {                         \
    .name       = (stringify(_field)),                               \
    .size       = sizeof(PlatformBusDevice),                                 \
    .vmsd       = &vmstate_platform_device,                               \
    .flags      = VMS_STRUCT,                                        \
}
