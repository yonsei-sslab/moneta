...
DEF("loadvm-sp", HAS_ARG, QEMU_OPTION_loadvm_sp, \
    "-loadvm-sp [tag|id]\n" \
    "                start right away with a saved state (loadvm-sp in monitor)\n",
    QEMU_ARCH_ALL)
STEXI
@item -loadvm-sp @var{file}
@findex -loadvm-sp
Start right away with a saved state (@code{loadvm-sp} in monitor)
ETEXI
