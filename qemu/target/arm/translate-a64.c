 ...
 * +-----------------------+------------------------+----------+
 */
static void disas_exc(DisasContext *s, uint32_t insn, CPUARMState *env)
{
...
static void disas_b_exc_sys(DisasContext *s, uint32_t insn, CPUARMState *env)
{
